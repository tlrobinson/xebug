...
var packagePath = FILE.path(module.path).dirname().dirname().dirname();

function getXDSource() {
    return packagePath.join("xd.js").read({ charset : "UTF-8" });
}

var fileServer = require("jack/file").File(packagePath.join("root"));
